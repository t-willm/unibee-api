...
type DetailQueryReq struct {
	g.Meta    `path:"/merchant_balance_query" tags:"Merchant-Balance" method:"get,post" summary:"Query Merchant Gateway Balance"`
...
type UserDetailQueryReq struct {
	g.Meta    `path:"/user_balance_query" tags:"Merchant-Balance" method:"get,post" summary:"Query User Balance"`
