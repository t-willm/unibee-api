...
type PdfGenerateReq struct {
	g.Meta        `path:"/pdf_generate" tags:"Invoice" method:"post" summary:"Admin Generate Merchant Invoice pdf"`
...
type SendEmailReq struct {
	g.Meta    `path:"/send_email" tags:"Invoice" method:"post" summary:"Admin Send Merchant Invoice Email to User"`
	InvoiceId string `json:"invoiceId" dc:"Invoice ID" v:"required"`
}
...
type ListReq struct {
	g.Meta        `path:"/list" tags:"Invoice" method:"get,post" summary:"Invoice List"`
...
type DeleteReq struct {
	g.Meta    `path:"/delete" tags:"Invoice" method:"post" summary:"Admin Delete Invoice Of Pending Status"`
