...
type CopyReq struct {
	g.Meta    `path:"/copy" tags:"Product" method:"post" summary:"CopyProduct"`
...
type ActivateReq struct {
	g.Meta    `path:"/activate" tags:"Product" method:"post" summary:"ActivateProduct"`
	ProductId uint64 `json:"productId" dc:"ProductId" v:"required"`
}
...
type InactiveReq struct {
	g.Meta    `path:"/inactivate" tags:"Product" method:"post" summary:"InactivateProduct" `
	ProductId uint64 `json:"productId" dc:"ProductId" v:"required"`
}
...
type DetailReq struct {
	g.Meta    `path:"/detail" tags:"Product" method:"get,post" summary:"ProductDetail"`
	ProductId uint64 `json:"productId" dc:"ProductId" v:"required"`
}
...
type DeleteReq struct {
	g.Meta    `path:"/delete" tags:"Product" method:"post" summary:"DeleteProduct" dc:"Product can being deleted when has no plan linked"`
	ProductId uint64 `json:"productId" dc:"ProductId" v:"required"`
}
