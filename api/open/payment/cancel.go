...
type CancelsReq struct {
	g.Meta               `path:"/cancels/{PaymentsPspReference}" tags:"Open-Payment-Controller" method:"post" summary:"1.3 取消⽀付单"`
	PaymentsPspReference string `in:"path" dc:"平台支付单号" v:"required"`
