...
type SubscriptionPlanCreateReq struct {
	g.Meta             `path:"/subscription_plan_create_and_activate" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划创建"`
...
type SubscriptionPlanEditReq struct {
	g.Meta             `path:"/subscription_plan_edit" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划修改(覆盖模式）"`
...
type SubscriptionPlanAddonsBindingReq struct {
	g.Meta   `path:"/subscription_plan_addons_binding" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划 Addons 绑定"`
...
type SubscriptionPlanListReq struct {
	g.Meta     `path:"/subscription_plan_list" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划列表"`
	MerchantId int64  `p:"merchantId" d:"15621" dc:"MerchantId" v:"required|length:4,30#请输入商户号"`
...
type SubscriptionPlanChannelTransferAndActivateReq struct {
	g.Meta `path:"/subscription_plan_activate" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划支付通道激活并发布"`
	PlanId int64 `p:"planId" dc:"订阅计划 ID" v:"required#请输入订阅计划 ID"`
...
type SubscriptionPlanChannelActivateReq struct {
	g.Meta    `path:"/subscription_plan_channel_activate" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划支付单通道激活"  deprecated:"true" `
	PlanId    int64 `p:"planId" dc:"订阅计划 ID" v:"required#请输入订阅计划 ID"`
	ChannelId int64 `p:"channelId"    v:"required#请输入 ConfirmChannelId" `
}
...
type SubscriptionPlanChannelDeactivateReq struct {
	g.Meta    `path:"/subscription_plan_channel_deactivate" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划支付单通道取消激活" deprecated:"true" `
	PlanId    int64 `p:"planId" dc:"订阅计划 ID" v:"required#请输入订阅计划 ID"`
	ChannelId int64 `p:"channelId"    v:"required#请输入 ConfirmChannelId" `
}
...
type SubscriptionPlanDetailReq struct {
	g.Meta `path:"/subscription_plan_detail" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划详情"`
	PlanId int64 `p:"planId" dc:"订阅计划 ID" v:"required#请输入订阅计划 ID"`
}
...
type SubscriptionPlanExpireReq struct {
	g.Meta    `path:"/subscription_plan_expire" tags:"Subscription-Plan-Merchant-Controller" method:"post" summary:"订阅计划过期"`
	PlanId    int64 `p:"planId" dc:"订阅计划 ID" v:"required#请输入订阅计划 ID"`
