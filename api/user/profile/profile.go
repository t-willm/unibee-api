...
type ProfileReq struct {
	g.Meta `path:"/profile" tags:"User-Profile-Controller" method:"get" summary:"1.1 get user profile"`
...
type ProfileUpdateReq struct {
	g.Meta `path:"/profile" tags:"User-Profile-Controller" method:"post" summary:"1.1 update user profile"`
