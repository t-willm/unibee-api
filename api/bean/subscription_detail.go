...
type SubscriptionDetail struct {
	...
	AddonParams                         []*PlanAddonParam                `json:"addonParams" dc:"AddonParams"`
	Addons                              []*PlanAddonDetail               `json:"addons" dc:"Addon"`
...
type SubscriptionTimeLineDetail struct {
	...
	Addons          []*PlanAddonDetail `json:"addons" description:"Addon"`
...
type SubscriptionPendingUpdateDetail struct {
	...
	Plan                 *PlanSimplify           `json:"plan" dc:"Plan"`
	Addons               []*PlanAddonDetail      `json:"addons" dc:"Addons"`
	UpdatePlan           *PlanSimplify           `json:"updatePlan" dc:"UpdatePlan"`
	UpdateAddons         []*PlanAddonDetail      `json:"updateAddons" dc:"UpdateAddons"`
