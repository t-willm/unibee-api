...
type ExternalDiscountParam struct {
	...
	DiscountPercentage *int64            `json:"discountPercentage" dc:"Percentage of discount, 100=1%"`
	CycleLimit         *int              `json:"cycleLimit"         dc:"the count limitation of subscription recurring cycle"`
