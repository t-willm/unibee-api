...
type BulkChannelSyncReq struct {
	g.Meta     `path:"/invoice_bulk_sync" tags:"System-Admin-Controller" method:"post" summary:"Admin Bulk Sync Invoice From Gateway"`
...
type ChannelSyncReq struct {
	g.Meta     `path:"/invoice_sync" tags:"System-Admin-Controller" method:"post" summary:"Admin Sync Invoice From Gateway"`
	MerchantId string `p:"merchantId" dc:"merchantId" v:"required#请输入merchantId"`
