...
type CountryRate struct {
	...
	Gateway               string      `json:"gateway"               ` // vat channel name, em vatsense
	...
	StandardTaxPercentage int64       `json:"standardTaxPercentage" ` // Standard Tax 万分比，1000 表示 10%
	...
	Provinces             string      `json:"provinces"             ` // Whether the country has provinces with provincial sales tax
