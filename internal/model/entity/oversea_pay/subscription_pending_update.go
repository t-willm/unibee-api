...
type SubscriptionPendingUpdate struct {
	...
	Status               int         `json:"status"               description:"订阅单状态，0-Init | 1-Create｜2-Active｜3-Suspend"`                                                                                                             // 订阅单状态，0-Init | 1-Create｜2-Active｜3-Suspend
	...
	UpdatedAddonData     string      `json:"updatedAddonData"     description:"升级到plan addon json data"`                                                                                                                                // 升级到plan addon json data
	ChannelId            int64       `json:"channelId"            description:"支付渠道Id"`                                                                                                                                                 // 支付渠道Id
	UserId               int64       `json:"userId"               description:"userId"`                                                                                                                                                 // userId
	ChannelUpdateId      string      `json:"channelUpdateId"      description:"支付渠道订阅更新单id"`                                                                                                                                            // 支付渠道订阅更新单id
