...
// SubscriptionPaymentTimeline is the golang structure of table subscription_payment_timeline for DAO operations like Where/Data.
type SubscriptionPaymentTimeline struct {
	g.Meta         `orm:"table:subscription_payment_timeline, do:true"`
	Id             interface{} //
