...
type OverseaPayDao struct {
	...
	columns OverseaPayColumns // columns contains all the column names of Table for convenient usage.
}

// OverseaPayColumns defines and stores column names for table oversea_pay.
type OverseaPayColumns struct {
	Id                 string // 主键id
...
// overseaPayColumns holds the columns for table oversea_pay.
var overseaPayColumns = OverseaPayColumns{
	Id:                 "id",
...
// NewOverseaPayDao creates and returns a new DAO object for table data access.
func NewOverseaPayDao() *OverseaPayDao {
	return &OverseaPayDao{
		group:   "oversea_pay",
		table:   "oversea_pay",
		columns: overseaPayColumns,
	}
}

// DB retrieves and returns the underlying raw database management object of current DAO.
func (dao *OverseaPayDao) DB() gdb.DB {
	return g.DB(dao.group)
}

// Table returns the table name of current dao.
func (dao *OverseaPayDao) Table() string {
	return dao.table
}

// Columns returns all column names of current dao.
func (dao *OverseaPayDao) Columns() OverseaPayColumns {
	return dao.columns
}

// Group returns the configuration group name of database of current dao.
func (dao *OverseaPayDao) Group() string {
	return dao.group
}

// Ctx creates and returns the Model for current DAO, It automatically sets the context for current operation.
func (dao *OverseaPayDao) Ctx(ctx context.Context) *gdb.Model {
...
func (dao *OverseaPayDao) Transaction(ctx context.Context, f func(ctx context.Context, tx gdb.TX) error) (err error) {
