...
type MerchantDiscountCodeColumns struct {
	...
	Amount            string // amount of discount, avalible when discount_type is fixed_amount
	Currency          string // currency of discount, avalible when discount_type is fixed_amount
	UserLimit         string // the limit of every user apply, 0-unlimit
	SubscriptionLimit string // the limit of every subscription apply, 0-unlimit
	StartTime         string // start of discount avalible utc time
	EndTime           string // end of discount avalible utc time
