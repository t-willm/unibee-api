...
type PayssionWebhook struct {
}

func (c PayssionWebhook) GatewayNewPaymentMethodRedirect(r *ghttp.Request, gateway *entity.MerchantGateway) (err error) {
	return nil
}
...
func (c PayssionWebhook) GatewayWebhook(r *ghttp.Request, gateway *entity.MerchantGateway) {
